...
export const GENERATORS: Generator[] = [
   ...
   },
   {
      ...
      productionMultiplier: {
         proofs: new Decimal(0.08),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
      },
      levelScaling: new Decimal(2.2),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(3.5),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
      },
      productionMultiplier: {
         proofs: new Decimal(0.06),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
      },
      levelScaling: new Decimal(2.0),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(12),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
      },
      productionMultiplier: {
         proofs: new Decimal(0.05),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
      },
      levelScaling: new Decimal(1.8),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(45),
         followers: new Decimal(0.05),
         paranoia: new Decimal(0),
      },
      productionMultiplier: {
         proofs: new Decimal(0.04),
         followers: new Decimal(0.01),
         paranoia: new Decimal(0),
      },
      levelScaling: new Decimal(1.6),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(180),
         followers: new Decimal(0.12),
         paranoia: new Decimal(0.1),
      },
      productionMultiplier: {
         proofs: new Decimal(0.035),
         followers: new Decimal(0.008),
         paranoia: new Decimal(0.005),
      },
      levelScaling: new Decimal(1.4),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(750),
         followers: new Decimal(0.28),
         paranoia: new Decimal(0.2),
      },
      productionMultiplier: {
         proofs: new Decimal(0.03),
         followers: new Decimal(0.006),
         paranoia: new Decimal(0.004),
      },
      levelScaling: new Decimal(1.25),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
   ...
   },
   {
      ...
      baseProduction: {
         proofs: new Decimal(3200),
         followers: new Decimal(0.65),
         paranoia: new Decimal(0.4),
      },
      productionMultiplier: {
         proofs: new Decimal(0.025),
         followers: new Decimal(0.005),
         paranoia: new Decimal(0.003),
      },
   ...
   },
   {
      ...
      baseCost: {
         proofs: new Decimal(10000000),
         followers: new Decimal(0),
      },
      costMultiplier: {
         proofs: new Decimal(1.07),
         followers: new Decimal(0),
      },
      baseProduction: {
         proofs: new Decimal(14000),
         followers: new Decimal(1.5),
         paranoia: new Decimal(0.8),
      },
      productionMultiplier: {
         proofs: new Decimal(0.02),
         followers: new Decimal(0.004),
         paranoia: new Decimal(0.002),
      },
   ...
   },
   {
      ...
      baseCost: {
         proofs: new Decimal(46000000),
         followers: new Decimal(0),
      },
      costMultiplier: {
         proofs: new Decimal(1.06),
         followers: new Decimal(0),
      },
      baseProduction: {
         proofs: new Decimal(65000),
         followers: new Decimal(3.5),
         paranoia: new Decimal(1.6),
      },
      productionMultiplier: {
         proofs: new Decimal(0.015),
         followers: new Decimal(0.003),
         paranoia: new Decimal(0.0015),
      },
      levelScaling: new Decimal(1.05),
      conditions: {
         proofs: new Decimal(0),
         followers: new Decimal(0),
         paranoia: new Decimal(0),
