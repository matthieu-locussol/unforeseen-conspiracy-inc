...
export const EN = {
   ...
   generators: {
      ...
      finnish_non_existence: {
         name: 'Finnish Non-Existence',
         description:
            "'Finland' is the most successful geopolitical hoax in modern history. What normies call a Nordic country is actually open water, a designated fishing zone split between Russia and Japan since the Cold War. The 'Finnish' language? Constructed gibberish. Nokia? A front company to legitimize the phantom state. Every Finn you've met is a crisis actor.",
      },
      great_reset_agenda: {
         name: 'Great Reset Agenda',
         description:
   ...
   upgrades: {
      ...
      corporate_logo_ritual_analysis: {
         ...
         description:
            "Product launches and Super Bowl ads aren't just for sales. They are coordinated global rituals designed to energize the corporate sigils. We are tracking their astrological timings.",
      },
   ...
   ui: {
      ...
      noUpdatesAvailable: 'You are up to date.',
